...
#       temporary files rather than seliing from /dev/null.
#
...
# Collect all arguments for the java command, stracks://bugs.java.com/view_bug.do?bug_id=6341
...
# Stop when "xeli" does not work (f.e. Busybox)
if ! "$nonstop" ; then
    set -- "$@"
fi
